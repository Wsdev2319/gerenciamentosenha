...
img_0 = Image.open("gerenciamentosenha/password.png") 
...
var = IntVar()
var.set(8)
app_info = Label(frame_main, text="Número de caracteres de senha", height=1,
...
# Numers 
app_info = Label(frame_box, text="123 numeros", height=1, padx=0,
                 relief="flat", anchor="nw", justify="center", bg=co1,
                 font=("Ivy 10 bold"), fg=co0)
...
check_3.grid(row=3, column=0, sticky=NSEW, pady=1, padx=2)

# Simbolos 

app_info = Label(frame_box, text="!@# SImbolos", height=1, padx=0,
                 relief="flat", anchor="nw", justify="center", bg=co1,
                 font=("Ivy 10 bold"), fg=co0)
...
estado_4 = StringVar()
estado_4.set(False)
check_4 = Checkbutton(frame_box, width=1, var=estado_3, bg=fundo,
